...
public class Ghost extends GameObject {
	...
	public Ghost(Node currentNode, Pacman pacMan, GameBoard board, GhostType ghostType) {
		...
		try {
			switch (ghostType) {
			case Red:
				ghostSprite[0] = ImageIO.read(getClass().getResource("/ghost_red_right.png")); // 우
				ghostSprite[1] = ImageIO.read(getClass().getResource("/ghost_red_up.png")); // 상
				ghostSprite[2] = ImageIO.read(getClass().getResource("/ghost_red.png")); // 좌
				ghostSprite[3] = ImageIO.read(getClass().getResource("/ghost_red_down.png")); // 하
